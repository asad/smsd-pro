...
def main(selected: List[str] | None = None, limit_png: int | None = None) -> None:
    ...
    cases: List[Tuple[str,str,str,str]] = [
        ...
        ("rdkit_blog_degenerate", "Nc1ccc(cc1)C-Cc1c(N)cccc1", "Nc1ccc(cc1)C=Cc1c(N)cccc1", "RDKit blog MCS degeneracy (para vs ortho)"),
        ("gh_1585_slowA", "c1cc(c(c(c1)Cl)N2c3cc(cc(c3CNC2=O)c4ccc(cc4F)F)N5CCNCC5)Cl", "CCNc1cc(c2c(c1)N(C(=O)NC2)c3ccc(cc3)n4ccc-5ncnc5c4)c6ccnnc6", "GitHub #1585 'particularly slow' example A"),
        ("mlist_ring_opts", "C(NC1=NCCN1)c1cccs1", "OCCNC(=O)c1cccs1", "rdkit-discuss ringMatches examples"),
        ("java_like_amide", "CC(=O)NCC", "CC(=O)NCCO", "amide/amine growth (common in examples)"),
    ]
    ...
    # Copy this script to test_output for reproducibility
    try:
