...
"""Simple side-by-side PNG comparison of SMSD vs RDKit reference.

Always write to test_output/ and keep the visuals minimal and readable.
...
def viz_compare_mcs_png(mol1: str|Chem.Mol,
    ...
    # RDKit FMCS reference (sizes only)
